...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/13 07:12:39 by mgomes-d          #+#    #+#             */
/*   Updated: 2023/06/13 09:41:02 by mgomes-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->_haveHP()){
		...
		if (!this->_haveHP()){
			std::cout << "ClapTrap " << this->_Name << " has been death" << std::endl;
		}
	}
	return ;
}
...
bool ClapTrap::_haveEnergy(void)
{
